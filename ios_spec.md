...
#### 3.1.1.1. iOS (security-scoped bookmarks — Swift):*
...
## 5.1. Pitch Frame Timing, Jitter, and Mic Delay
...
### 5.1.1. Pitch frame rate and missing frames
...
### 5.1.2. Mic Capture and FFT-YIN Pitch Detection Pipeline
...
#### 5.1.2.1. Primitive Memory Management (Normative)
...
#### 5.1.2.2. Algorithm Pipeline (Normative)
...
#### 5.1.2.3. Consolidated Sensitivity Table
...
# 6. Multiplayer, Pairing, and Session Lifecycle

## 6.1. Pairing UX (Phone)
...
### 7.2.1. Service Discovery — Phone (Android & iOS)
...
### 7.3.2. Message Definitions (Common)
...
## 7.4. Versioning & Compatibility (Common)
...
### 7.6.2. Frame Generation & Transmission (Phone — Android & iOS)
...
### 7.7.2. HTTP File Server — iOS Phone
...
### 7.8.1. Clock Model & Sync Schedule (Common)
...
### 7.8.3. Per-Sample Computation — Phone
